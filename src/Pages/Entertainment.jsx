...
const Entertainment = () => {
  ...
  useEffect(() => {
    axios.get(`https://newsapi.org/v2/top-headlines?category=entertainment&apiKey=${import.meta.env.REACT_APP_API_KEY}`)
      .then(response => {
  ...
  return (
    <div>
      <header><h1>Entertainment Headlines</h1></header>
