...
const General = () => {
  ...
  useEffect(() => {
    axios.get(`https://newsapi.org/v2/top-headlines?category=general&apiKey=${import.meta.env.REACT_APP_API_KEY}`)
      .then(response => {
  ...
  return (
    <div>
      <header><h1>General Headlines</h1></header>
